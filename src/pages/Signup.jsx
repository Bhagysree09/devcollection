    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden md:block space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <img
                ...
                className="rounded-xl shadow-lg h-64 w-full object-cover transform hover:scale-105 transition duration-500"
              />
              <img
          ...
          <div className="bg-white py-10 px-8 shadow-xl rounded-2xl sm:px-12">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
              <img
                className="mx-auto h-12 w-auto animate-fade-in"
                ...
                alt="Dev Collection"
              />
              <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900 animate-fade-in-delay">
                Create your account
              </h2>
              <p className="mt-2 text-center text-sm text-gray-600 animate-fade-in-delay-2">
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  ...
                  <p className="text-gray-500">
                    ...
                    <Link to="/privacy-policy" className="text-indigo-600 hover:text-indigo-500 transition-colors duration-300">
                      Privacy Policy
                    </Link>
                  </p>
                </div>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform hover:scale-105 transition duration-300"
                >
                  Create Account
                </button>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transform hover:scale-105 transition duration-300"
                >
